...
enum Status {
  ...
  @MappableValue("BENEFICIARY_SICK") beneficiarySick,
  @MappableValue("BENEFICIARY_ABSENT") beneficiaryAbsent,
  @MappableValue("ADMINISTERED") administered,
  @MappableValue("NOT_ADMINISTERED") notAdministered,
  ;
}