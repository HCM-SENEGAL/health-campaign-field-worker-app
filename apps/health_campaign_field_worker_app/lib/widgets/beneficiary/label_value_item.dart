  ...
  Widget _buildValue(dynamic value, BuildContext context) {
    ...
    if (value is String) {
      return Text(
        ...
        style: valueTextStyle ?? (textTheme.bodyLarge),
      );
      ...
      return Wrap(
        ...
        children: value
          ...
          maxLines: maxLines,
          overflow: TextOverflow.ellipsis,
          style: valueTextStyle ?? (textTheme.bodyLarge!.copyWith(
    ...
    return Padding(
      ...
      child: isInline
        ...
        children: [
          ...
          const SizedBox(width: 48), // Optional spacing between label and value
          Expanded(
            flex: valueFlex,
