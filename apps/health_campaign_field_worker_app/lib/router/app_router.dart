...
import '../pages/beneficiary_registration/widgets/beneficiary_acknowledgement.dart';
  ...
  routes: [
    ...
    AutoRoute(
      ...
      children: [
        ...
        AutoRoute(page: BeneficiaryAcknowledgementPage, path: 'beneficiary-acknowledgement'),
